...
/* /1* VarDef *1/ */
/* /1*     : Specifier DecList { $$ = new_parent_node("VarDef", GROUP_9 + 1, 2, $1, $2); } *1/ */
/* /1*     | PatternMatching { $$ = new_parent_node("VarDef", GROUP_9 + 2, 1, $1); } *1/ */
/* /1*     ; *1/ */
/* NID(901) */
/*     if (childNum == 2) */
/*     { */
...
/* /1* DecList *1/ */
/* /1*     : Dec { $$ = new_parent_node("DecList", GROUP_9 + 3, 1, $1); } *1/ */
/* /1*     | Dec COMMA DecList { $$ = new_parent_node("DecList", GROUP_9 + 4, 2, $1, $3); } *1/ */
/* /1*     ; *1/ */
/* NID(903) */
/*     if (childNum == 1) */
/*     { */
...
/* /1* Dec *1/ */
/* /1*     : VarDec { $$ = new_parent_node("Dec", GROUP_9 + 5, 1, $1); } *1/ */
/* /1*     | VarDec ASSIGNOP Exp { $$ = new_parent_node("Dec", GROUP_9 + 6, 2, $1, $3); } *1/ */
/* /1*     ; *1/ */
/* NID(905) */
/*     if (childNum == 1) */
/*     { */
...
/* /1* Declarators *1/ */
/* /1* VarDec *1/ */
/* /1*     : LOWERID { $$ = new_parent_node("VarDec", GROUP_9 + 7, 1, $1); } *1/ */
/* /1*     ; *1/ */
/* NSD(907) */
/*     D_parent_info; */
...
/* /1* Using Variables *1/ */
/* /1* VarUse *1/ */
/* /1*     : LOWERID { $$ = new_parent_node("VarUse", GROUP_9 + 8, 1, $1); } *1/ */
/* NSD(908) */
/*     D_child_1; */
