...
/* /1* Specifiers *1/ */
/* /1* Specifier *1/ */
/* /1*     : BUILDINTYPE { $$ = new_parent_node("Specifier", GROUP_8 + 1, 1, $1); } *1/ */
/* /1*     | LET { $$ = new_parent_node("Specifier", GROUP_8 + 2, 1, $1); } *1/ */
/* /1*     | TypeId { $$ = new_parent_node("Specifier", GROUP_8 + 3, 1, $1); } *1/ */
/* /1*     | ArrayType { $$ = new_parent_node("Specifier", GROUP_8 + 4, 1, $1); } *1/ */
/* /1*     | ReferType { $$ = new_parent_node("Specifier", GROUP_8 + 5, 1, $1); } *1/ */
/* /1*     | FuncType { $$ = $1; } *1/ */
/* /1*     ; *1/ */
...
/*     assert(parent->other_info == NULL); */
/*     /1* parent->other_info = child_1_info; *1/ */
